...
describe('achCbModel', function () {
    ...
    describe('#validate', function () {
        ...
        it('should fail submitOtherPOR request validation as comments and uploaded files info not provided ', function (next){
            achCbModel.validationErrors=[];
            req.body = {
                disputeCategory: "1",
        ...
        it('should pass submitOtherPOR request validation as files info has been provided ', function (next){
            achCbModel.validationErrors=[];
            req.body = {
                disputeCategory: "1",
                action: "submitOtherPOR",
            ...
            req.files = uploadedFiles;
            achCbModel.validate(req);
            assert.equal(achCbModel.validationErrors.length,0, "No Error thrown");
            //assert.equal(achCbModel.validationErrors[0].otherPORComments, "COMMON_001","Failed with different error");
            next();
        });
